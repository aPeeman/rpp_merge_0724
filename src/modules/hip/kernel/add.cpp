...
/*template <typename T>
extern "C" __global__ void add_npp_batch(T *input1,
                                     T *input2,
                                     T *output,
                                     unsigned int *xroi_begin,
                                     unsigned int *xroi_end,
...
extern "C" __global__ void add_32f_batch(float *input1,
                                     float *input2,
                                     float *output,
                                     unsigned int *xroi_begin,
                                     unsigned int *xroi_end,
...
/*template <typename T>
RppStatus hiptonpp_exec_add_batch(T *srcPtr1, T *srcPtr2, T *dstPtr, rpp::Handle& handle, RppiChnFormat chnFormat, Rpp32u channel, Rpp32s plnpkdind, Rpp32u max_height, Rpp32u max_width)
{
    int localThreads_x = 32;
    int localThreads_y = 32;
    int localThreads_z = 1;
    ...
    hipLaunchKernelGGL(add_npp_batch,
                       dim3(ceil((float)globalThreads_x/localThreads_x), ceil((float)globalThreads_y/localThreads_y), ceil((float)globalThreads_z/localThreads_z)),
                       dim3(localThreads_x, localThreads_y, localThreads_z),
                       0,
                       handle.GetStream(),
...
RppStatus hip32f_exec_add_batch(Rpp32f *srcPtr1, Rpp32f *srcPtr2, Rpp32f *dstPtr, rpp::Handle& handle, RppiChnFormat chnFormat, Rpp32u channel, Rpp32s plnpkdind, Rpp32u max_height, Rpp32u max_width)
{
    ...
    hipLaunchKernelGGL(add_32f_batch,
                       dim3(ceil((float)globalThreads_x/localThreads_x), ceil((float)globalThreads_y/localThreads_y), ceil((float)globalThreads_z/localThreads_z)),
                       dim3(localThreads_x, localThreads_y, localThreads_z),
                       0,
                       handle.GetStream(),
