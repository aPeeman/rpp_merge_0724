...
//                                       const int plnpkdindex) // use 1 pln 3/4 for pkd
// {
//     int id_x = hipBlockIdx_x * hipBlockDim_x + hipThreadIdx_x;
//     int id_y = hipBlockIdx_y * hipBlockDim_y + hipThreadIdx_y;
//     int id_z = hipBlockIdx_z * hipBlockDim_z + hipThreadIdx_z;
...
// }
template <typename T>
__global__ void flip_batch(void *srcPtr_void,
                                      void *dstPtr_void,
                                      unsigned int *flipAxis,
                                      unsigned int *height,
                                      unsigned int *width,
...
template __global__ void flip_batch<unsigned char>(void*, void*, unsigned int*, unsigned int*, unsigned int*, unsigned int*, unsigned long long*, unsigned int*, unsigned int*, unsigned int*, unsigned int*, const unsigned int, unsigned int*, const int);
template __global__ void flip_batch<int>(void*, void*, unsigned int*, unsigned int*, unsigned int*, unsigned int*, unsigned long long*, unsigned int*, unsigned int*, unsigned int*, unsigned int*, const unsigned int, unsigned int*, const int);
template __global__ void flip_batch<float>(void*, void*, unsigned int*, unsigned int*, unsigned int*, unsigned int*, unsigned long long*, unsigned int*, unsigned int*, unsigned int*, unsigned int*, const unsigned int, unsigned int*, const int);
template __global__ void flip_batch<unsigned short>(void*, void*, unsigned int*, unsigned int*, unsigned int*, unsigned int*, unsigned long long*, unsigned int*, unsigned int*, unsigned int*, unsigned int*, const unsigned int, unsigned int*, const int);
...
__global__ void flip_batch(void *srcPtr_void,
                                      ...
                                      const int plnpkdindex) // use 1 pln 3/4 for pkd
{   
    T* srcPtr = static_cast<T*>(srcPtr_void);
    T* dstPtr = static_cast<T*>(dstPtr_void);    
...
RppStatus hip_exec_flip_batch(Rpp8u *srcPtr, Rpp8u *dstPtr, rpp::Handle& handle, RppiChnFormat chnFormat, Rpp32u channel, Rpp32s plnpkdind, Rpp32u max_height, Rpp32u max_width)
{
    ...
    hipLaunchKernelGGL(flip_batch<unsigned char>,
...
RppStatus hip_exec_flip_batch_s32(Rpp32s *srcPtr, Rpp32s *dstPtr, rpp::Handle& handle, RppiChnFormat chnFormat, Rpp32u channel, Rpp32s plnpkdind, Rpp32u max_height, Rpp32u max_width)
{
    int localThreads_x = 32;
    int localThreads_y = 32;
    int localThreads_z = 1;
    ...
    hipLaunchKernelGGL(flip_batch<int>,
                       dim3(ceil((float)globalThreads_x/localThreads_x), ceil((float)globalThreads_y/localThreads_y), ceil((float)globalThreads_z/localThreads_z)),
                       dim3(localThreads_x, localThreads_y, localThreads_z),
                       0,
                       handle.GetStream(),
...
RppStatus hip_exec_flip_batch_f32(Rpp32f *srcPtr, Rpp32f *dstPtr, rpp::Handle& handle, RppiChnFormat chnFormat, Rpp32u channel, Rpp32s plnpkdind, Rpp32u max_height, Rpp32u max_width)
{
    int localThreads_x = 32;
    int localThreads_y = 32;
    int localThreads_z = 1;
    ...
    hipLaunchKernelGGL(flip_batch<float>,
                       dim3(ceil((float)globalThreads_x/localThreads_x), ceil((float)globalThreads_y/localThreads_y), ceil((float)globalThreads_z/localThreads_z)),
                       dim3(localThreads_x, localThreads_y, localThreads_z),
                       0,
                       handle.GetStream(),
...
RppStatus hip_exec_flip_batch_u16(Rpp16u *srcPtr, Rpp16u *dstPtr, rpp::Handle& handle, RppiChnFormat chnFormat, Rpp32u channel, Rpp32s plnpkdind, Rpp32u max_height, Rpp32u max_width)
{
    int localThreads_x = 32;
    int localThreads_y = 32;
    int localThreads_z = 1;
    ...
    hipLaunchKernelGGL(flip_batch<unsigned short>,
                       dim3(ceil((float)globalThreads_x/localThreads_x), ceil((float)globalThreads_y/localThreads_y), ceil((float)globalThreads_z/localThreads_z)),
                       dim3(localThreads_x, localThreads_y, localThreads_z),
                       0,
                       handle.GetStream(),
